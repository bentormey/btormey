...
You can grab a weight tracking spreadsheet [here](https://drive.google.com/open?id=1pTS0x-9m8XKafIuUMQi7fvN1gglt9jLY) and the exact Python code I used for the machine learning stuff on [GitHub](https://github.com/bentormey/machine-learning-weight). Contact me if you want help setting it up.
